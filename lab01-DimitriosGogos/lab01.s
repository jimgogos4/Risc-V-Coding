...
matric: # Words ending with ':' are **labels**
        ...
        .word 5085  # This directive reserves enough space for a word in memory
                  #  and initializes it with the value of my AM.
matricplus1:
        .word 0   
...
prog:   # Labels in code are used for control flow: if/then/else, loops, etc.
        ...
        lw         s0, 0(a0)         # Get value of AM into register s0. li - load immediate
